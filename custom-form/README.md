# Okta Angular + (Non-widget) Custom Login Example

This example shows you how to use the [Okta Angular Library][] to login a user to an Angular application.  The login is achieved with a simple login form, meant as example for those who want to build fully 100% custom UI.
...
cd samples-js-angular/custom-form
```
...
If you see a home page that prompts you to login, then things are working!  Clicking the **Login** button will render custom login page component (a barebones username/password login form) to perform authentication.
